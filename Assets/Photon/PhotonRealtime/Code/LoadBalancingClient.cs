...
namespace Photon.Realtime
{
    ...
    public class LoadBalancingClient : IPhotonPeerListener
    {
        ...
        {
            Debug.Log("Disconnect by LoadBalancingClient");
        ...
        public bool OpJoinRoom(EnterRoomParams enterRoomParams)
        {
            ...
            {
                Debug.Log("OpJoinRoomEnded CheckIfOpCanBeSent:false");
            ...
            Debug.Log("OpJoinRoomEnded sending:"+sending);
        ...
        public virtual void OnStatusChanged(StatusCode statusCode)
        {
            switch (statusCode)
            {
                ...
                case StatusCode.DisconnectByServerUserLimit:
                    ...
                    this.DisconnectedCause = DisconnectCause.MaxCcuReached;
                    Debug.Log("DisconnectByServerUserLimit");
                ...
                case StatusCode.EncryptionFailedToEstablish:
                    ...
                    Debug.Log("EncryptionFailedToEstablish");
                ...
                case StatusCode.DisconnectByServerTimeout:
                    ...
                    Debug.Log("DisconnectByServerTimeout");
                    this.State = ClientState.Disconnecting;
                    break;
